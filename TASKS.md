...
- [x] 2.2 支持多种格式 (Base64, Clash, Sing-box)
- [x] 2.3 聚合所有在线节点的代理配置
- [x] 2.4 面板添加订阅链接显示和复制按钮

### 3. Sing-box 配置下发
- [x] 3.1 Master 面板添加配置编辑器
- [x] 3.2 支持预设模板 (VLESS/VMess/Hysteria2/Reality)
- [x] 3.3 Node Agent 接收配置并重启 Sing-box
- [x] 3.4 配置验证和错误处理
...
### 6. 配置模板系统
- [x] 6.1 预设 VLESS + XTLS-Vision + TLS 模板
- [x] 6.2 预设 VMess + WS 模板
- [x] 6.3 预设 Hysteria2 模板
- [x] 6.4 模板参数化 (UUID/端口/域名自动填充)
- [x] 6.5 Node 端自动初始化预设配置
- [x] 6.6 Master 端聚合订阅链接 (带开关)
- [x] 6.7 配置更新后自动重启容器
...
| 2025-12-06 | 1.9.12 | 添加 Rebuild 按钮，--both 自动连接 |
| 2025-12-06 | 1.9.13 | 添加订阅生成、Master/Gateway Rebuild |
| 2025-12-06 | 1.9.14 | 添加 Sing-box 配置模板系统 |
| 2025-12-06 | 1.9.15 | 预设模板自动配置、聚合订阅、自动重启 |
| 2025-12-06 | 1.9.16 | 移除 System Controls，修复服务状态加载 |
...
| 2025-12-06 | 1.9.21 | Master 面板防火墙管理、修复更新功能 |
